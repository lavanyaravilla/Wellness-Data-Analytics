...
def scrape_justdial(category="Gyms", scroll_time=60):
    ...
    with sync_playwright() as p:
        ...
        page.wait_for_selector("div.resultbox", timeout=60000, state='attached')
        listings = page.locator("div.resultbox")
        ...
        # Save results
        df = pd.DataFrame(list(gyms.values()))
...
if __name__ == "__main__":
    scrape_justdial(category="Gyms", scroll_time=60)
