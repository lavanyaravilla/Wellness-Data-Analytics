...
def scrape_karate_dojo(scroll_time=60):
    url = "https://www.justdial.com/Bangalore/karate-dojo"
    ...
    with sync_playwright() as p:
        ...
        df.to_csv("output/justdial_karate_dojo.csv", index=False)
        df.to_excel(f"output/justdial_karate_dojo_{int(time.time())}.xlsx", index=False)

        browser.close()

if __name__ == "__main__":
    scrape_karate_dojo(scroll_time=60)
